<template>
	<section class="role-management">
		<div class="bg-light lter b-b wrapper-md"><h1 class="m-n font-thin h3">游戏管理</h1></div>
		<div class="wrapper-md">
			<!-- search bar -->
		  <el-row :gutter="20">
		  	<el-col :span="19">
				  <el-autocomplete class="inline-input" v-model="searchValue" :fetch-suggestions="querySearch" placeholder="请输入需要查找的游戏" :trigger-on-focus="false"  @select="handleSelect" style="width: 100%;">
				  	<!--<el-button slot="append" icon="search"></el-button>-->
				  </el-autocomplete>
		  	</el-col>
 				<el-col :span="5">
 					<el-button type="primary" icon="plus" @click="dialogFormVisible = true">创建游戏</el-button>
 				</el-col>
		  </el-row>
		  <!-- / search bar -->
		  ...
		  <el-row>
			  <el-table :data="currentData" v-loading.body="loading" style="width: 100%" :row-class-name="filterRowDisable" border>
			    <el-table-column prop="name" label="游戏名" :formatter="filterEmpty"></el-table-column>
			    <el-table-column prop="gameid" label="游戏ID" :formatter="filterEmpty"></el-table-column>
		  ...
		  <el-table :data="detailData" border>
		    ...
		    <el-table-column inline-template label="内容">
		    	<section>
			      ...
			      <template v-else>
			      	<template v-if="row.name==='status' || row.name==='category'">
		...
		<!-- add component -->
		<el-dialog title="创建游戏" v-model="dialogFormVisible" @close="handleReset">
			<el-form :model="form" :rules="formrules" ref="form" label-width="80px">
				<el-form-item label="游戏名" prop="name">
					<el-input v-model="form.name" auto-complete="off" placeholder="例：三国杀"></el-input>
				</el-form-item>
				<el-form-item label="游戏ID" prop="gameid">
					<el-input v-model="form.gameid" auto-complete="off" placeholder="例：1"></el-input>
				</el-form-item>
				<el-form-item label="描述" prop="description">
					<el-input v-model.number="form.description" auto-complete="off" placeholder="例：这是一款广受好评的游戏"></el-input>
				</el-form-item>
				<el-form-item label="类别" prop="category">
					<el-select v-model="form.category" placeholder="请选择游戏类型">
						<el-option label="射击类" value="0"></el-option>
						<el-option label="情景类" value="1"></el-option>
						<el-option label="赛车类" value="2"></el-option>
					</el-select>
				</el-form-item>
			</el-form>
