<template>
	<section class="customer-management">
		<div class="bg-light lter b-b wrapper-md"><h1 class="m-n font-thin h3">用户管理</h1></div>
		<div class="wrapper-md">
		  ...
		  <el-row>
		  	<el-table :data="currentData" v-loading.body="loading" style="width: 100%" :row-class-name="filterRowDisable" border>
			    <el-table-column prop="name" label="姓名" :formatter="filterEmpty"></el-table-column>
			    <el-table-column prop="departmentname" label="部门" :formatter="filterEmpty"></el-table-column>
			    <el-table-column prop="rolesname" label="角色" :formatter="filterEmpty"></el-table-column>
			    <el-table-column prop="gamesname" label="游戏" :formatter="filterEmpty"></el-table-column>
